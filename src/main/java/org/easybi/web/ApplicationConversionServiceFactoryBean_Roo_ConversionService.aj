...
import org.easybi.service.PizzaService;
import org.easybi.service.ToppingService;
import org.easybi.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Base, String> ApplicationConversionServiceFactoryBean.getBaseToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.easybi.domain.Base, java.lang.String>() {
    ...
    public Converter<Long, Base> ApplicationConversionServiceFactoryBean.getIdToBaseConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.easybi.domain.Base>() {
            public org.easybi.domain.Base convert(java.lang.Long id) {
    ...
    public Converter<String, Base> ApplicationConversionServiceFactoryBean.getStringToBaseConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.easybi.domain.Base>() {
            public org.easybi.domain.Base convert(String id) {
    ...
    public Converter<Pizza, String> ApplicationConversionServiceFactoryBean.getPizzaToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.easybi.domain.Pizza, java.lang.String>() {
    ...
    public Converter<Long, Pizza> ApplicationConversionServiceFactoryBean.getIdToPizzaConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.easybi.domain.Pizza>() {
            public org.easybi.domain.Pizza convert(java.lang.Long id) {
    ...
    public Converter<String, Pizza> ApplicationConversionServiceFactoryBean.getStringToPizzaConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.easybi.domain.Pizza>() {
            public org.easybi.domain.Pizza convert(String id) {
    ...
    public Converter<PizzaOrder, String> ApplicationConversionServiceFactoryBean.getPizzaOrderToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.easybi.domain.PizzaOrder, java.lang.String>() {
    ...
    public Converter<PizzaOrderPk, PizzaOrder> ApplicationConversionServiceFactoryBean.getIdToPizzaOrderConverter() {
        return new org.springframework.core.convert.converter.Converter<org.easybi.domain.PizzaOrderPk, org.easybi.domain.PizzaOrder>() {
            public org.easybi.domain.PizzaOrder convert(org.easybi.domain.PizzaOrderPk id) {
    ...
    public Converter<String, PizzaOrder> ApplicationConversionServiceFactoryBean.getStringToPizzaOrderConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.easybi.domain.PizzaOrder>() {
            public org.easybi.domain.PizzaOrder convert(String id) {
    ...
    public Converter<Topping, String> ApplicationConversionServiceFactoryBean.getToppingToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.easybi.domain.Topping, java.lang.String>() {
    ...
    public Converter<Long, Topping> ApplicationConversionServiceFactoryBean.getIdToToppingConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.easybi.domain.Topping>() {
            public org.easybi.domain.Topping convert(java.lang.Long id) {
    ...
    public Converter<String, Topping> ApplicationConversionServiceFactoryBean.getStringToToppingConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.easybi.domain.Topping>() {
            public org.easybi.domain.Topping convert(String id) {
    ...
    public Converter<String, PizzaOrderPk> ApplicationConversionServiceFactoryBean.getJsonToPizzaOrderPkConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.easybi.domain.PizzaOrderPk>() {
    ...
    public Converter<PizzaOrderPk, String> ApplicationConversionServiceFactoryBean.getPizzaOrderPkToJsonConverter() {
        return new org.springframework.core.convert.converter.Converter<org.easybi.domain.PizzaOrderPk, java.lang.String>() {
